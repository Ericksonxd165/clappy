...
<div className="h-screen bg-red-600 flex flex-col items-center justify-center">
  <div className="w-full max-w-xs bg-white rounded-lg shadow-md p-6">
    ...
    <form className="flex flex-col" onSubmit={handleSubmit}>
      ...
      <button onClick={handleSubmit} className="bg-gradient-to-r from-red-500 to-red-500 text-white font-bold py-2 px-4 rounded-md mt-4  hover:to-blue-600 transition ease-in-out duration-150">
        Login
      </button>
    </form>
  </div>
